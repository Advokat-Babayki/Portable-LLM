...
function Get-ModelSizeMB {
    ...
    if ($match.Success) {
        ...
        switch -Regex ($fnameUpper) {
            {$_ -match "IQ4_NL|IQ4"} { $quantFactor = 0.52 }
            {$_ -match "Q2_K|IQ2_"} { $quantFactor = 1.0 }
            {$_ -match "Q3_K_M"} { $quantFactor = 0.64 }
            {$_ -match "Q3_K_S"} { $quantFactor = 0.58 }
            {$_ -match "Q3_K"} { $quantFactor = 0.61 }
            {$_ -match "Q3_"} { $quantFactor = 0.59 }
            {$_ -match "Q4_0|Q4_1"} { $quantFactor = 0.55 }
            {$_ -match "Q4_K_S"} { $quantFactor = 0.53 }
            {$_ -match "Q4_K_M"} { $quantFactor = 0.56 }
            {$_ -match "Q4_K_L"} { $quantFactor = 0.60 }
            {$_ -match "Q4_K"} { $quantFactor = 0.57 }
            {$_ -match "Q4_"} { $quantFactor = 0.55 }
            {$_ -match "Q5_0|Q5_1"} { $quantFactor = 0.75 }
            {$_ -match "Q5_K_S"} { $quantFactor = 0.72 }
            {$_ -match "Q5_K_M"} { $quantFactor = 0.78 }
            {$_ -match "Q5_K"} { $quantFactor = 0.75 }
            {$_ -match "Q5_"} { $quantFactor = 0.76 }
            {$_ -match "Q6_K"} { $quantFactor = 0.85 }
            {$_ -match "Q6_"} { $quantFactor = 0.85 }
            {$_ -match "Q8_0"} { $quantFactor = 1.20 }
            {$_ -match "Q8_1"} { $quantFactor = 1.19 }
            {$_ -match "Q8_"} { $quantFactor = 1.20 }
            {$_ -match "Q2_"} { $quantFactor = 1.0 }
            {$_ -match "Q3_"} { $quantFactor = 0.60 }
            {$_ -match "Q4_"} { $quantFactor = 0.56 }
            {$_ -match "Q5_"} { $quantFactor = 0.75 }
            {$_ -match "Q6_"} { $quantFactor = 0.85 }
            {$_ -match "Q8_"} { $quantFactor = 1.20 }
            {$_ -match "F16|FP16"} { $quantFactor = 2.10 }
            {$_ -match "F32|FP32"} { $quantFactor = 4.20 }
